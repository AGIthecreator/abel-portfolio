...
export function ActResult({
  ...
  return createPortal(
    ...
    >
      <div
        className="flex min-h-[100svh] w-full flex-col items-center justify-center pt-[max(1.5rem,env(safe-area-inset-top,0px))] pr-[max(1.25rem,env(safe-area-inset-right,0px))] pb-[max(1.5rem,env(safe-area-inset-bottom,0px))] pl-[max(1.25rem,env(safe-area-inset-left,0px))] sm:px-8"
      >
