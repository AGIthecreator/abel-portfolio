      ...
      <FadeIn className="relative z-20 h-full w-full flex items-center justify-center px-6">
        <div className="w-full flex flex-col items-center text-center">
          ...
          <div className="flex flex-col gap-6 mb-10 w-full items-center">
            {/* Se eliminó pr-10 para centrado real */}
            ...
            {/* CENTRADO AUTOMÁTICO: Se eliminó pr-20 y ml-3 */}
            ...
            <p className="text-lg sm:text-xl text-white/40 max-w-2xl mx-auto font-light leading-relaxed">
              Full Stack Developer enfocado en <span className="text-white/80">SaaS y automatización</span>. Desarrollo sistemas reales con pagos y workflows en producción.
            </p>
          </div>
